...
public class FaststartTestContainer extends TestContainer {

    public FaststartTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "com/company/faststart/app.properties",
    ...
    public static class Common extends FaststartTestContainer {

        public static final FaststartTestContainer.Common INSTANCE = new FaststartTestContainer.Common();
